...
from conftest import user_data, prepare_user, prepare_login_password
...
class TestLoginCourier:
    ...
    def test_login(self, prepare_user):
        get_data_courier = prepare_user[1]
    ...
    def test_required_field_login(self, prepare_login_password, field):
        ...
        get_data_courier = self.api.login_courier(prepare_login_password)
    ...
    def test_login_not_exist(self,user_data):
        ...
        response = self.api.login_courier(user_data)
